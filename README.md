...
## Running the Program
1. Change the location for saving the labels in the part of **command** part of the docker-compose.yml file:
```sh
    command: bash /MS3D/tools/cfgs/target_custom/label_generation/round1_automated_pipeline/scripts/automated_pipeline_general.sh --save_dir_label "location to save the label"
```
