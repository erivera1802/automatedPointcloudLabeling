...
class CustomDataset(DatasetTemplate):
    ...
    def get_lidar(self, lidar_path, ext='.pcd'):
        ...
        """
        # print("ms3dd???", lidar_path)
        # lidar_path= "/MS3D/" + lidar_path
        if ext == '.pcd':
    ...
    def evaluation(self, det_annos, class_names, **kwargs):
        ...
        # print("hey: ", kwargs.keys(), kwargs.values())
        ...
        if kwargs['eval_metric'] == 'kitti':
            ...
            self.logger.info('Doing evaluation - using kitti official eval')
    ...
    for seq_idx, seq_name in enumerate(seq_names):
        ...
        for frame_idx, fname in enumerate(sample_file_list):
            try:
                ...
                lidar_timestamp = np.int64(fname.stem.split('_')[-1])                                            
            frame_info = {}
