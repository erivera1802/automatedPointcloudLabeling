...
def calculate_iou_partly(gt_annos, dt_annos, metric, num_parts=50):
    ...
    for num_part in split_parts:
        ...
        # print('gtt locAA',gt_annos_part[0]['location'])
        # print('ddtt locAA',dt_annos_part[0]['location'])
    ...
    # print('??? overlap', parted_overlaps[0]) #???????????????
    ...
    # print('??? overlap',overlaps[1] , parted_overlaps[1]) #???????????????
...
def eval_class(gt_annos,
    ...
    # print('parted_overlaps!',parted_overlaps)
...
def do_eval(gt_annos,
    ...
    difficultys = [0, 1, 2]
    # print('DTTT',dt_annos[0])
    # print('GTTT',gt_annos[0])
    print('HERE: DO EVAL')
...
def get_official_eval_result(gt_annos, dt_annos, current_classes, PR_detail_dict=None):
    ...
    # print('det location',dt_annos[0])
    # print('gt location',gt_annos[0])
