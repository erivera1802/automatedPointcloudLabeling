...
def transform_argo_GT_to_kitti_format(annos, map_name_to_kitti=None, info_with_fakelidar=False):
    """
    Args:
        annos:
    ...
    for anno in annos:        
        ...
        #from argoverse GT data to kitti format:
        # gt_boxes_lidar = []
        # for a, b, c in zip(anno['location'], anno['dimensions'], anno['rotation_y']):
        #     temp = []
        #     temp.extend(a) 
        #     temp.extend(b)     
        #     temp.extend([c])
    ...
    for anno in annos:        
        ...
        if 'boxes_lidar' in anno:
            ...
            for a, b, c in zip(anno['location'], anno['dimensions'], anno['rotation_y']):
                ...
                gt_boxes_lidar.append(temp)
            gt_boxes_lidar = np.array(gt_boxes_lidar)
            # print('ERROR - NO GT BOX LIDAR KEY IN ANNO!')
