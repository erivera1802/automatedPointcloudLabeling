...
def get_pose(dataset, frame_id):
    ...
    if dataset.dataset_cfg.DATASET == 'ONCEDataset':
        ...
        return pose
    elif dataset.dataset_cfg.DATASET in ['WaymoDataset','CustomDataset', 'Argo2Dataset']:
        infos_idx = dataset.frameid_to_idx[frame_id]
...
def get_lidar(dataset, frame_id):
    ...
    elif dataset.dataset_cfg.DATASET == 'Argo2Dataset':
        return dataset.get_lidar(dataset.infos[infos_idx]['lidar_path'])    #????
    else:
        raise NotImplementedError
...
def get_sample_idx(dataset, frame_id):
    ...
    elif dataset.dataset_cfg.DATASET in ['NuScenesDataset','LyftDataset','Argo2Dataset']:
        return dataset.infos[infos_idx]['sample_idx']        
...
def get_timestamp(dataset, frame_id):
    ...
    if dataset.dataset_cfg.DATASET == 'ONCEDataset':
        ...
        return dataset.infos[infos_idx]['timestamp_ns']
    else:
        raise NotImplementedError                
...
def get_gt_boxes(dataset, frame_id):
    ...
    # elif dataset.dataset_cfg.DATASET in ['Argo2Dataset']:
    #     return dataset[infos_idx]['gt_boxes']
    elif dataset.dataset_cfg.DATASET in ['WaymoDataset','CustomDataset','Argo2Dataset']:
        return dataset.infos[infos_idx]['annos']['gt_boxes_lidar']
    else:
        raise NotImplementedError
...
def get_gt_names(dataset, frame_id):
    infos_idx = dataset.frameid_to_idx[frame_id]
    if dataset.dataset_cfg.DATASET in ['ONCEDataset', 'Argo2Dataset']:
