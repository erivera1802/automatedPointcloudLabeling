...
if __name__ == '__main__':
    ...
    with open('/MS3D/tools/cfgs/target_argo/label_generation/round1/E1_final_results.txt', 'a') as f:
        f.write(item_result)
     

    # cd tools
    #python cfgs/evaluate_waymo_initial_ps.py --cfg_file /MS3D/tools/cfgs/dataset_configs/waymo_dataset_da.yaml --ps_dict /MS3D/tools/cfgs/target_waymo/label_generation/round1/ps_labels/initial_pseudo_labels.pkl
    #python cfgs/evaluate_waymo_initial_ps.py --cfg_file /MS3D/tools/cfgs/dataset_configs/waymo_dataset_da.yaml --ps_dict /MS3D/tools/cfgs/target_waymo/label_generation/round1/ps_labels/final_ps_dict.pkl
