...
# ---- single frame ----
python3 test.py --cfg_file ../model_zoo/lyft_pretrained/cfgs/lyft_uda_voxel_rcnn_centerhead_1xyz_allcls.yaml \
                --ckpt ../model_zoo/lyft_pretrained/lyft_uda_voxel_rcnn_centerhead_1xyz_allcls.pth \
...
# python3 test.py --cfg_file ../model_zoo/lyft_pretrained/cfgs/lyft_voxel_rcnn_centerhead_3f_xyzt_allcls.yaml \
