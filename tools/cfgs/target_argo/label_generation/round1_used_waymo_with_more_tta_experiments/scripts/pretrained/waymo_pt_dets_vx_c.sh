#!/bin/bash
# idp-ms3d/model_zoo/waymo_pretrained/waymo_uda_voxel_rcnn_centerhead_1xyz_allcls.pth
python3 test.py --cfg_file ../model_zoo/waymo_pretrained/cfgs/waymo_uda_voxel_rcnn_centerhead_1xyz_allcls.yaml \
                --ckpt ../model_zoo/waymo_pretrained/waymo_uda_voxel_rcnn_centerhead_1xyz_allcls.pth \
