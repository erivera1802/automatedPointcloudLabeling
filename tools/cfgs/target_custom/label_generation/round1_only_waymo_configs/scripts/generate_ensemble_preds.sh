...
bash /MS3D/tools/cfgs/target_custom/label_generation/round1/scripts/pretrained/waymo_pt_dets_pv_a.sh
bash /MS3D/tools/cfgs/target_custom/label_generation/round1/scripts/pretrained/waymo_pt_dets_pv_c.sh
