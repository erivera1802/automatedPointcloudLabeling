...
# waymo_uda_pv_rcnn_plusplus_resnet_anchorhead_1xyz_allcls.yaml
# waymo_uda_pv_rcnn_plusplus_resnet_anchorhead_1xyz_allcls.pth

python3 test.py --cfg_file ../model_zoo/waymo_pretrained/cfgs/waymo_uda_pv_rcnn_plusplus_resnet_anchorhead_1xyz_allcls.yaml \
                --ckpt ../model_zoo/waymo_pretrained/waymo_uda_pv_rcnn_plusplus_resnet_anchorhead_1xyz_allcls.pth \
