...
def parse_config():
    ...
    ### MODIFIED
    temp_data_path = args.cfg_file.split('/') 
    temp_data_path[1] = temp_data_path[1] + '_' + cfg.DATA_CONFIG_TAR.DATA_PATH.split('/')[-1] ### EXTRACT FOLDER NAME FROM TARGET DATASET DA YAML
    cfg.EXP_GROUP_PATH = '/'.join(temp_data_path[1:-1]) 
    ### MODIFIED
