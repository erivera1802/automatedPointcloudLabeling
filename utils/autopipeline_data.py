...
def main(rosbag_folder_name, save_dir):

    rosbag_folder_path = '/MS3D/pointclouds_final'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--rosbag_folder_name', type=str, required=False, default= 'DO_ALL', help='Path to the rosbag folder.')
    parser.add_argument('--save_dir', type=str, required=True, help='Directory where the processed data will be saved.')
    
    args = parser.parse_args()
    main(args.rosbag_folder_name, args.save_dir)
